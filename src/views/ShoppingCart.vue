...
<template>
    <section class="main__cart">
        <article class="cart__article cart__info">
            ...
            <router-link class="cart__home-link" to="/">Continuar comprando<img class="icon--small"
                    src="../assets/img/flecha-correcta.png" alt=""></router-link>
        </article>
            ...
            <ul v-if="total != 0" class="cart__list">
                <li v-for="course in courses" class="cart__item">
                    <div class="item__right">
                        ...
                        <div class="item__info">
                            <div class="item__group">
                                <h3 class="item__title">{{ course.title }}</h3>
                                <span class="item__author">Un curso de {{ course.author }}</span>
                            </div>
                            <span class="item__span">Audio: {{ course.language }}</span>
                            <span class="item__span" v-if="course.subtitle">Subtítulos: {{ course.subtitle.join(', ')
                            }}</span>
                    ...
                    <div class="item__left">
                        ...
                        <img @click="eliminateCourseInCart(course.id)" class="item__delete icon click"
                            src="../assets/img/quitar-del-carrito.png" alt="">
                    </div>
